...
<head>
    ...
    <div class="container">
        ...
        <tbody>
        <?php
            $mysqli = new mysqli(DB_HOST3, DB_USER3, DB_PASS3, DB_NAME3);
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='detalle.php?dia=" . $row['fecha'] . "'>" . $row['fecha'] . "</a></td>";
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const ventasChart = new Chart(ctx, {
            ...
            data: {
                labels: ['Efectivo', 'Crédito', 'Débito', 'MercadoP'], // Etiquetas para el gráfico
                datasets: [{
                    label: 'Ventas',
                    data: [0, 0, 0, 0], // Datos iniciales vacíos
                    backgroundColor: [
                        'rgba(54, 162, 235, 0.6)',
                        'rgba(75, 192, 192, 0.6)',
                        'rgba(255, 206, 86, 0.6)',
